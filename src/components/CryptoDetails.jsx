      ...
      <Col className="stats-container">
        ...
        <Col className="coin-value-info">
          ...
          {genericStats.map(({ icon, title, value }) => (
            <Col className="coin-genericStats">
              <Col className="coin-genericStats-name">
                <Text>{icon}</Text>
                <Text>{title}</Text>
              </Col>
              <Text className="genericStats">{value}</Text>
            </Col>
          ))}
        </Col>
      </Col>
      <Col className="coin-desc-link">
        <Row className="coin-desc">
          <Title level={3} className='coin-details-heading'>
            ...
            {/* description is a raw html so we need to use HTML REACT PARSER */}
          </Title>
        </Row>
